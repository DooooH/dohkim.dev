...
export const en = {
  ...
  'home.worksEmpty':
    'Add work under <code>src/content/work</code> to surface the latest projects here.',
  'home.latestBlogEyebrow': 'Latest blog',
  'home.allPosts': 'All posts',
  'home.postsEmpty':
    'Add writing under <code>src/content/writing</code> to surface the latest notes here.',
  ...
  'notFound.blog': 'Read the writing',
